...
def main():
    ...
    """ 1. Load data """    
    df_examples = pd.read_csv(f"/content/Data/data/processed/public/task_1_query-product_ranking/train-v0.3.csv")
    df_products = pd.read_csv(f"/content/Data/data/processed/public/task_2_multiclass_product_classification/product_catalogue-v0.3.csv")
    df_products[col_product_title] = df_products[col_product_title].astype(str)
    df_examples_products = pd.merge(
        df_examples,
        df_products,
        how='left',
        left_on=[col_query_locale, col_product_id],
